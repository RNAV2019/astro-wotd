...
var middlewareSecret = "b284118d-1631-4431-9aae-13be001dc144";
//#endregion
...
function deserializeActionResult(res) {
	if (res.type === "error") {
		...
		if (Object.assign({
			...
			"SITE": void 0,
			"SSR": true
		}, { _: "/home/ryan/Projects/astro-wotd/node_modules/.bin/astro" })?.PROD) return {
...
function serializeActionResult(res) {
	if (res.error) {
		if (Object.assign({
			...
			"SITE": void 0,
			"SSR": true
		}, { _: "/home/ryan/Projects/astro-wotd/node_modules/.bin/astro" })?.DEV) actionResultErrorStack.set(res.error.stack);
		let body2;
...
[
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/api/word.json.ts",
			"pathname": "/api/word.json",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
...
var _page0 = () => import("./chunks/generic_cY7P5ItN.mjs");
var _page1 = () => import("./chunks/word_BNuEyWbK.mjs");
var _page2 = () => import("./chunks/index_B8CBcxLb.mjs");
var pageMap = /* @__PURE__ */ new Map([
	["node_modules/astro/dist/assets/endpoint/generic.js", _page0],
	["src/pages/api/word.json.ts", _page1],
	["src/pages/index.astro", _page2]
]);
//#endregion
//#region \0virtual:astro:manifest
var _manifest = deserializeManifest({"rootDir":"file:///home/ryan/Projects/astro-wotd/","cacheDir":"file:///home/ryan/Projects/astro-wotd/node_modules/.astro/","outDir":"file:///home/ryan/Projects/astro-wotd/dist/","srcDir":"file:///home/ryan/Projects/astro-wotd/src/","publicDir":"file:///home/ryan/Projects/astro-wotd/public/","buildClientDir":"file:///home/ryan/Projects/astro-wotd/dist/client/","buildServerDir":"file:///home/ryan/Projects/astro-wotd/dist/server/","adapterName":"@astrojs/vercel","assetsDir":"_astro","routes":[{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"type":"page","component":"_server-islands.astro","params":["name"],"segments":[[{"content":"_server-islands","dynamic":false,"spread":false}],[{"content":"name","dynamic":true,"spread":false}]],"pattern":"^\\/_server-islands\\/([^/]+?)\\/?$","prerender":false,"isIndex":false,"fallbackRoutes":[],"route":"/_server-islands/[name]","origin":"internal","distURL":[],"_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/_image","component":"node_modules/astro/dist/assets/endpoint/generic.js","params":[],"pathname":"/_image","pattern":"^\\/_image\\/?$","segments":[[{"content":"_image","dynamic":false,"spread":false}]],"type":"endpoint","prerender":false,"fallbackRoutes":[],"distURL":[],"isIndex":false,"origin":"internal","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/word.json","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/word\\.json$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"word.json","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/word.json.ts","pathname":"/api/word.json","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/index.k1t0Dmwx.css"}],"routeData":{"route":"/","isIndex":true,"type":"page","pattern":"^\\/$","segments":[],"params":[],"component":"src/pages/index.astro","pathname":"/","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}}],"serverLike":true,"middlewareMode":"classic","base":"/","trailingSlash":"ignore","compressHTML":"jsx","componentMetadata":[["/home/ryan/Projects/astro-wotd/src/pages/index.astro",{"propagation":"none","containsHead":true}]],"renderers":[],"clientDirectives":[["idle","(()=>{var l=(n,t)=>{let i=async()=>{await(await n())()},e=typeof t.value==\"object\"?t.value:void 0,s={timeout:e==null?void 0:e.timeout};\"requestIdleCallback\"in window?window.requestIdleCallback(i,s):setTimeout(i,s.timeout||200)};(self.Astro||(self.Astro={})).idle=l;window.dispatchEvent(new Event(\"astro:idle\"));})();"],["load","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).load=e;window.dispatchEvent(new Event(\"astro:load\"));})();"],["media","(()=>{var n=(a,t)=>{let i=async()=>{await(await a())()};if(t.value){let e=matchMedia(t.value);e.matches?i():e.addEventListener(\"change\",i,{once:!0})}};(self.Astro||(self.Astro={})).media=n;window.dispatchEvent(new Event(\"astro:media\"));})();"],["only","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).only=e;window.dispatchEvent(new Event(\"astro:only\"));})();"],["visible","(()=>{var a=(s,i,o)=>{let r=async()=>{await(await s())()},t=typeof i.value==\"object\"?i.value:void 0,c={rootMargin:t==null?void 0:t.rootMargin},n=new IntersectionObserver(e=>{for(let l of e)if(l.isIntersecting){n.disconnect(),r();break}},c);for(let e of o.children)n.observe(e)};(self.Astro||(self.Astro={})).visible=a;window.dispatchEvent(new Event(\"astro:visible\"));})();"]],"entryModules":{"astro/entrypoints/prerender":"prerender-entry.22G10TrI.mjs","\u0000noop-middleware":"virtual_astro_middleware.mjs","\u0000virtual:astro:server-island-manifest":"chunks/_virtual_astro_server-island-manifest_C1Q2srgE.mjs","\u0000virtual:astro:session-driver":"chunks/_virtual_astro_session-driver_C-PI1Pas.mjs","\u0000virtual:astro:actions/noop-entrypoint":"chunks/noop-entrypoint_Z3zFhrGC.mjs","/home/ryan/Projects/astro-wotd/node_modules/@astrojs/react/dist/vnode-children.js":"chunks/vnode-children_B6vVcKTz.mjs","@astrojs/vercel/entrypoint":"entry.mjs","\u0000virtual:astro:page:node_modules/astro/dist/assets/endpoint/generic@_@js":"chunks/generic_cY7P5ItN.mjs","\u0000virtual:astro:page:src/pages/index@_@astro":"chunks/index_B8CBcxLb.mjs","/home/ryan/Projects/astro-wotd/node_modules/astro/dist/assets/services/sharp.js":"chunks/sharp_hsOhIWDX.mjs","\u0000virtual:astro:page:src/pages/api/word.json@_@ts":"chunks/word_BNuEyWbK.mjs","@astrojs/react/client.js":"_astro/client.BPCU-30U.js","/home/ryan/Projects/astro-wotd/src/pages/index.astro?astro&type=script&index=0&lang.ts":"_astro/index.astro_astro_type_script_index_0_lang.DxzKoPjf.js","astro:scripts/before-hydration.js":""},"inlinedScripts":[["/home/ryan/Projects/astro-wotd/src/pages/index.astro?astro&type=script&index=0&lang.ts","var e=new Date().toISOString().split(`T`)[0];function t(e){let t=document.getElementById(`word`),n=document.getElementById(`type-of-word`),r=document.getElementById(`definition`),i=document.getElementById(`example-sentence`),a=document.getElementById(`example-card`),s=document.getElementById(`word-content`);t&&(t.textContent=e.word),n&&(n.textContent=e.typeOfWord,n.style.display=e.typeOfWord?`inline-block`:`none`),r&&(r.textContent=e.definition?`“${e.definition}”`:``),i&&(i.textContent=e.example),a&&(a.style.display=e.example?`block`:`none`),s&&(s.style.opacity=`1`,s.style.transform=`translateY(0)`),o(e.word,e.example,e.audioUrl??null)}var n=null;function r(){let e=()=>{let e=window.speechSynthesis.getVoices();return e.find(e=>e.lang===`en-US`&&e.localService)??e.find(e=>e.lang===`en-GB`&&e.localService)??e.find(e=>e.lang.startsWith(`en`)&&e.localService)??e.find(e=>e.lang.startsWith(`en`))??null};n=e(),n||window.speechSynthesis.addEventListener(`voiceschanged`,()=>{n=e()},{once:!0})}function i(e){let t=window.speechSynthesis;t.cancel(),t.resume();let r=new SpeechSynthesisUtterance(e);n&&(r.voice=n),r.rate=.9,t.speak(r)}function a(e,t){if(t){new Audio(t).play().catch(()=>i(e));return}i(e)}r();function o(e,t,n){function r(e,t){let n=document.getElementById(e);if(!n)return;let r=n.cloneNode(!0);n.parentNode?.replaceChild(r,n),r.addEventListener(`click`,t)}r(`word-tts`,()=>a(e,n)),t&&r(`example-tts`,()=>i(t))}async function s(){try{let t=await fetch(`/api/word.json`);return t.ok?{...await t.json(),date:e}:null}catch{return null}}async function c(){let n=localStorage.getItem(`wotd`),r=n?JSON.parse(n):null;if(r?.date===e)t(r),s().then(e=>{e&&localStorage.setItem(`wotd`,JSON.stringify(e))});else{let e=await s();e&&(localStorage.setItem(`wotd`,JSON.stringify(e)),t(e))}}c(),document.addEventListener(`visibilitychange`,()=>{document.hidden||(new Date().toISOString().split(`T`)[0]===e?s().then(e=>{e&&localStorage.setItem(`wotd`,JSON.stringify(e))}):window.location.reload())});var l=document.getElementById(`theme-toggle`),u=document.documentElement;function d(){let e=u.getAttribute(`data-theme`)===`dark`,t=document.getElementById(`sun-icon`),n=document.getElementById(`moon-icon`),r=document.getElementById(`theme-label`);t&&(t.style.display=e?`none`:`block`),n&&(n.style.display=e?`block`:`none`),r&&(r.textContent=e?`Dark`:`Light`)}l?.addEventListener(`click`,()=>{let e=u.getAttribute(`data-theme`)===`dark`?`light`:`dark`;u.setAttribute(`data-theme`,e),localStorage.setItem(`theme`,e),d()}),d();"]],"assets":["/android-chrome-192x192.png","/android-chrome-512x512.png","/app.js","/apple-touch-icon.png","/favicon-16x16.png","/favicon-32x32.png","/favicon.ico","/icon-192x192.png","/icon-256x256.png","/icon-384x384.png","/icon-512x512.png","/manifest.json","/safari-pinned-tab.svg","/service-worker.js","/_astro/client.BPCU-30U.js","/_astro/index.k1t0Dmwx.css"],"buildFormat":"directory","checkOrigin":true,"actionBodySizeLimit":1048576,"serverIslandBodySizeLimit":1048576,"allowedDomains":[],"key":"XXAj8ekbf022T2IAF//X+7aOUzbZwdtmTVyR+D8j/i0=","image":{},"devToolbar":{"enabled":false,"debugInfoOutput":""},"logLevel":"info","shouldInjectCspMetaTags":false});
